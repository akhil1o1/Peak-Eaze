...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className="pointer-events-none rounded-md size-4 shrink-0 translate-y-0.5 transition-transform duration-200 bg-primary/10 text-primary hover:bg-primary/20" />
      </AccordionPrimitive.Trigger>
